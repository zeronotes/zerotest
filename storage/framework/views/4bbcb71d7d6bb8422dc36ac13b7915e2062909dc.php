			...
			<form method="post" class="m-form m-form--fit m-form--label-align-right">
				<div class="m-portlet__body">
					...
					<div class="form-group m-form__group row">
						...
						<div class="col-10">
							<input class="form-control m-input" name="email" type="email" placeholder="Enter your email" value="<?php echo e($user->email); ?>" readonly="">
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label for="example-url-input" class="col-2 col-form-label">Name</label>
						<div class="col-10">
							<input class="form-control m-input" value="<?php echo e($user->name); ?>" type="text" name="name" placeholder="Enter your name">
						</div>
					</div>
				</div>
