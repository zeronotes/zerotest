					...
					<div class="col-sm-9">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left"><?php echo e(count($products)); ?> products found</p>
								<div class="clearfix"></div>
							</div>
								...
								<div class="col-sm-4">
									<div class="single-item">
										<div class="single-item-header">
											<a href="<?php echo e(route('product', $item->product->slug)); ?>"><img src="/upload/images/products/<?php echo e($item->product->featured_image); ?>" alt=""></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title"><?php echo e($item->product->name); ?></p>
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="<?php echo e(route('product', $item->product->slug)); ?>">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
							...
							<div class="row"><?php echo e($products->links()); ?></div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="single-item">
										<div class="single-item-header">
											<a href="/single-product"><img src="assets/dest/images/products/1.jpg" alt=""></a>
										</div>
										<div class="single-item-body">
