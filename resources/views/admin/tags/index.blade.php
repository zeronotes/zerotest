...
<div class="row">
    ...
    <div class="m-portlet__head">
        ...
        <div class="m-portlet__head-tools">
            <form method="get" class="input-group" id="search_tags">
                <input type="hidden" name="_token" value="{{ csrf_token() }}" id="_token">
                <input type="text" class="form-control" name="name" id="name_search" placeholder="Enter name of tags...">
