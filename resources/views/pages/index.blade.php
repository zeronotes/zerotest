					...
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">{{ count($new_products) }} products found</p>
								...
								<div class="col-sm-3" style="margin-bottom: 25px">
									<div class="single-item">
										<div class="single-item-header">
											<a href="/san-pham/{{ $product->slug }}"><img src="/upload/images/products/{{ $product->featured_image }}" alt="{{ $product->name }}"></a>
										</div>
						...
						<div class="beta-products-list">
							<h4>Top Products</h4>
							<div class="beta-products-details">
								<p class="pull-left">{{ count($hot_products) }} products found</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
							@foreach($hot_products as $product)
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="shopping_cart.html"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="/san-pham/{{ $product->slug }}">Details <i class="fa fa-chevron-right"></i></a>
