								...
								<div class="col-sm-4">
									<div class="single-item">
										<div class="single-item-header">
											<a href="{{ route('product', $item->product->slug) }}"><img src="/upload/images/products/{{ $item->product->featured_image }}" alt=""></a>
										</div>
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="{{ route('product', $item->product->slug) }}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
